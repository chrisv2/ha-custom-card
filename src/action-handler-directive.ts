...
customElements.define('action-handler-uplinkswitcher', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-uplinkswitcher')) {
    return body.querySelector('action-handler-uplinkswitcher') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-uplinkswitcher');
